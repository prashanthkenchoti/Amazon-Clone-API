...
public class ContactServiceImpl implements ContactService {
	...
	@Override
	public ResponseEntity<ResponseStructure<ContactResponseDTO>> findContactByAddress(int addressId) {
		Address address= addressRepository.findById(addressId).orElseThrow(() -> new  AddressNotFoundException("Address Not Found"));
		//Contact contact = contactRepository.findById(address.getContact()).
		return null;
	}
